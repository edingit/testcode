...
if ( ! function_exists( 'edit_single_post_classes' ) ) :
/**
 * Function to change classes for single post page
 */
function edit_single_post_classes( $classes ) {
...
add_filter( 'post_class', 'edit_single_post_classes' );
?>