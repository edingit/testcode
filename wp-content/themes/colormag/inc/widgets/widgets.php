...
function colormag_widgets_init() {
   ...
   // Registering advertisement above related sidebar left col
   register_sidebar( array(
      'name'            => __( 'Single Page Left Sidebar Above Related Posts', 'colormag' ),
      'id'              => 'colormag_single_page_left_sidebar',
      'description'     => __( 'Shows widgets above related posts.', 'colormag' ),
      'before_widget'   => '<aside id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</aside>',
      'before_title'    => '<h3 class="widget-title"><span>',
      'after_title'     => '</span></h3>'
   ) );
   // Registering advertisement above related sidebar right col
   register_sidebar( array(
      'name'            => __( 'Single Page Right Sidebar Above Related Posts', 'colormag' ),
      'id'              => 'colormag_single_page_right_sidebar',
      'description'     => __( 'Shows widgets above related posts.', 'colormag' ),
      'before_widget'   => '<aside id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</aside>',
      'before_title'    => '<h3 class="widget-title"><span>',
